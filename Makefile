...
SRC = src/main.c src/server.c src/handlers.c src/http_client.c src/customer.c src/validation.c src/jwt.c src/odbcutil.c src/logger.c src/config.c src/worker_pool.c src/task_pool.c src/login.c src/totp.c src/json_util.c
